...
(function($, window, document, undefined){
   ...
   Charms.prototype = {
      ...
      showSection: function(sectionId, width){
         ...
         if (width != undefined)
            w = width;
         //sliding effect for the charms panel when opening
         //$(this.element).animate({ width: 'toggle' });
      ...
      close: function () {
          ...
          //sliding effect when closing the charms panel   
         // $(this.element).hide('slide', { direction: 'right' }, 1000); //.animate({ width: '0' }, this.options.animateDuration);
          //$(this.element).animate({ width: 'toggle' });
